...
const currencies = [
  { value: 1, label: "1", image: process.env.PUBLIC_URL + "/1.png" },
  { value: 2, label: "2", image: process.env.PUBLIC_URL + "/2.png" },
  { value: 5, label: "5", image: process.env.PUBLIC_URL + "/5.png" },
  { value: "10_coin", label: "10", image: process.env.PUBLIC_URL + "/10c.png" },
  { value: "20_coin", label: "20", image: process.env.PUBLIC_URL + "/20c.png" },
  { value: "10_note", label: "10", image: process.env.PUBLIC_URL + "/10.png" },
  { value: "20_note", label: "20", image: process.env.PUBLIC_URL + "/20.png" },
  { value: 50, label: "50", image: process.env.PUBLIC_URL + "/50.png" },
  { value: 100, label: "100", image: process.env.PUBLIC_URL + "/100.png" },
  { value: 200, label: "200", image: process.env.PUBLIC_URL + "/200.jpg" },
  { value: 500, label: "500", image: process.env.PUBLIC_URL + "/500.jpg" }
];
