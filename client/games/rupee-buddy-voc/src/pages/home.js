  ...
  return (
    <Container>
      ...
      <HeroSection>
        ...
        <Title>
          Rupee <TitleAccent>Buddy 2</TitleAccent>
        </Title>
      ...
      <CardsContainer>
        ...
        <GameCard className="test-card" onClick={() => handleNavigate('/add')}>
          <CardPattern />
          <CardIcon>➕</CardIcon>
          <CardTitle>Add Notes</CardTitle>
          <CardDescription>Make the target amount</CardDescription>
          <CardShine />
        </GameCard>

        <GameCard className="learn-card" style={{ background: "linear-gradient(135deg, #0fb639 0%, #097123 100%)" }} onClick={() => handleNavigate('/buy')}>
          <CardPattern />
          <CardIcon>🛒</CardIcon>
          <CardTitle>Buy Items</CardTitle>
          <CardDescription>Pay the exact price</CardDescription>
          <CardShine />
        </GameCard>
      </CardsContainer>
    </Container>
